...
import heapq
from dataset.paragragh_vector import voc_vec_return
...
tf.app.flags.DEFINE_string('word2vecmodel_path', os.path.abspath('./dataset/poems.model'), 'word2vecmodel_path')
tf.app.flags.DEFINE_string('cut_poems_file', './dataset/data/poems_cut.txt', 'cut_poems_file')
...
def run_training():
    ...
    # poems_vector,word_to_int,vocabularies = voc_vec_return(FLAGS.word2vecmodel_path, FLAGS.cut_poems_file)
